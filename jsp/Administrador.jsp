<%-- 
    ...
    Created on : 15/04/2016, 03:49:22 PM
    Author     : Sergio
--%>


<%@page import="Dto.EventoDto"%>
<%@page import="Dto.Imagen"%>
...
<html lang="en" class="no-js">
    ...
    <head>
        <title>SEGRE-ADMINISTRADOR</title>
            ...
            <div id="sidebar">
                ...
                <header class="sidebar-section">
                    ...
                    <div class="navbar-vertical">
                        <ul class="main-menu">
                            <li class="drop"><a class="active"  ><i class="fa fa-home"></i>Bienvenido Admin</a></li>
                            <li class="drop"><a  onclick="validarEgresados()" ><i class="fa fa-home"></i>Validar Egresados</a></li>
                            <li class="drop"><a><i class="fa fa-user"></i>Oferta de Empleo</a>
                                <ul class="drop-down">
                                    <li><a onclick="registrarOferta()">Subir</a></li>
                                    <li><a onclick="ofertaLaboral1()">Ver</a></li>
                                </ul></li>
                            <li class="drop"><a onclick="experienciasAprendias1()"><i class="fa fa-cog"></i>Experiencias Aprendidas</a></li>
                            <li class="drop"><a><i class="fa fa-user"></i>Encuestas</a>
                                <ul class="drop-down">
                                    <li><a onclick="subirEncuesta()">Actualizar</a></li>
                                    <li><a onclick="consu()">Consultas</a></li>
                                    <li><a onclick="reporte()">Reporte</a></li>
                                </ul>
                            </li>
                            <li class="drop"><a><i class="fa fa-user"></i>Acerca De</a>
                                <ul class="drop-down">
                                    <li><a onclick="subirE()">Eventos</a></li>
                                    <li><a onclick="galeria()">Galería</a></li>
                                    <li><a onclick="correo()">Enviar Correo</a></li>
                                </ul>
                            </li>
                            <li class="drop"><a class="active" onclick="Cerrar2()"  ><i class="fa fa-home"></i>Cerrar Sesion</a></li>
                        </ul>
                ...
                <div class="sidebar-section white-box">
                    <div class="social-box">
                        ...
                        <ul class="social-icons">
                            ...
                            <li><a class="page" href="http://ingsistemas.ufps.edu.co/"><i class="fa fa-mail-forward"></i></a></li>
                        </ul>
                    </div>
                </div>
